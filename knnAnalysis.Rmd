...
gg_miss_var(cancer_data[c(1, 2, 3, 4, 5)])
vis_miss(cancer_data[c(1, 2, 3, 4, 5)])
ggplot(data=cancer_data)

cancer_data <- cancer_data[-c(5, 8, 9, 18, 25, 26, 46, 47, 48, 49)]
cancer_data_2[cancer_data_2=="?"] <- NA

cancer_data_2 <- cancer_data[complete.cases(cancer_data), ]

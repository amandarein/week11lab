...
### Log Loss
We calculate the Log Loss of the model to be 0.55. This is a pretty good score! We don't have a balanced data set (80% of our data is for high-rated coffee shops!), so this is especially good for what we are working with.
```{r, message=FALSE, echo = FALSE, warning=FALSE}
